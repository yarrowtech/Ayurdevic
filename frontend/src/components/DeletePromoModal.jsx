...
export default function DeletePromoModal({ promo, busy, onCancel, onConfirm }) {
  ...
  return (
    <dialog
      ...
      aria-describedby="delete-promo-description"
      aria-busy={busy}
    ...
    >
      <div className="p-6 sm:p-8">
        ...
        <h2 id="delete-promo-title" className="text-2xl font-semibold tracking-tight">Delete popup?</h2>
        <p id="delete-promo-description" className="mt-3 text-sm leading-6 text-stone-600">
          <span className="font-semibold text-stone-800 break-words">“{promo.title || "Image popup"}”</span> will be permanently deleted and will no longer appear to shoppers. This cannot be undone.
        </p>
      </div>
      <div className="flex flex-col-reverse gap-3 border-t border-stone-100 bg-stone-50 px-6 py-4 sm:flex-row sm:justify-end sm:px-8">
        ...
        <button type="button" disabled={busy} onClick={onConfirm} className="inline-flex items-center justify-center gap-2 rounded-lg bg-red-700 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-red-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-700 disabled:cursor-wait disabled:opacity-60">
